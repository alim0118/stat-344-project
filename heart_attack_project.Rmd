...
stratified_male.index <- sample.int(male_sample_size, replace = F)
male_sample <- heartattack[stratified_male.index,]
head(male_sample)

stratified_female.index <- sample.int(female_sample_size,replace = F)
female_sample <- heartattack[stratified_female.index,]
head(female_sample)
...
data.frame(Sample = c("SRS","Stratified Estimate"),
           `BMI Mean` = c(SRS_BMI_mean,strata_estimator_BMI_mean))
```
Calculate standard error
```{r}
#Calculcate SE for SRS and Stratified
